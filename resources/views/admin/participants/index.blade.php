<x-admin-layout>
    ...
    <div class="bg-white p-6 rounded-lg shadow-md">
        ...
        <form method="GET" action="{{ route('admin.participants.index') }}" class="mb-6 flex flex-col md:flex-row gap-4 items-end">
            <div class="flex-grow">
                <label for="search" class="block text-sm font-medium text-gray-700">Cari Peserta</label>
                <input type="text" name="search" id="search" placeholder="Cari nama atau email..." value="{{ request('search') }}" class="mt-1 w-full border-gray-300 rounded-md shadow-sm">
            </div>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Jenis Peserta</th>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr>
                        <td class="px-6 py-4">
                            <div class="flex items-center">
                                <div class="flex-shrink-0 h-10 w-10">
                                    <img class="h-10 w-10 rounded-full object-cover" src="{{ $registration->user->avatar ? Storage::url($registration->user->avatar) : 'https://placehold.co/40x40/E2E8F0/4A5568?text=AV' }}" alt="">
                                </div>
                                <div class="ml-4">
                        ...
                        <td class="px-6 py-4 text-sm text-gray-500">{{ $registration->participant_type }}</td>
                        ...
                        <td class="px-6 py-4 text-sm font-medium">
                            <a href="{{ route('admin.participants.show', $registration) }}" class="text-indigo-600 hover:text-indigo-900">Lihat Detail</a>
                        </td>
                    </tr>
                    @empty
                    <tr>
