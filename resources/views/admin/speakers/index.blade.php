<x-admin-layout>
    <x-slot name="header">
        Manajemen Keynote Speakers
    </x-slot>

    <div class="p-6 bg-white rounded-lg shadow-md">
        <div class="flex justify-between items-center mb-4">
            <h2 class="text-xl font-semibold">Daftar Speaker</h2>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                <div class="flex items-center space-x-4">
                                    ...
                                    <form action="{{ route('admin.speakers.destroy', $speaker) }}" method="POST" onsubmit="return confirm('Anda yakin ingin menghapus speaker ini?');">
                                        @csrf
                                        @method('DELETE')
                    ...
                    @empty
                        <tr>
                            <td colspan="3" class="px-6 py-4 text-center text-gray-500">Belum ada data speaker.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
