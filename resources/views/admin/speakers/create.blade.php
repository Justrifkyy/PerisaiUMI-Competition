    ...
    <div class="p-6 bg-white rounded-lg shadow-md">
        <form action="{{ route('admin.speakers.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <div class="mt-2 flex items-center gap-x-3">
                        <img id="image-preview" class="h-24 w-24 rounded-full object-cover bg-gray-200" src="https://placehold.co/96x96/E2E8F0/4A5568?text=Foto" alt="Image preview">
            ...
            <div class="flex items-center justify-end mt-6">
                ...
                <x-primary-button>Simpan Speaker</x-primary-button>
            </div>
        </form>
    </div>
