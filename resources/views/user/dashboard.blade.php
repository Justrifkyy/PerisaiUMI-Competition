<x-app-layout>
    ...
    <div class="relative min-h-screen bg-black py-12 overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 relative z-10">
            ...
            @if (session('status'))
                <div class="mb-8 p-4 bg-green-500/10 border-l-4 border-green-500 rounded-r-xl backdrop-blur-xl" role="alert">
            ...
            @if ($isPending)
                <div class="mb-8 p-4 bg-yellow-500/10 border-l-4 border-yellow-500 rounded-r-xl backdrop-blur-xl">
            ...
            @elseif ($isRejected)
                <div class="mb-8 p-4 bg-red-500/10 border-l-4 border-red-500 rounded-r-xl backdrop-blur-xl">
            ...
            <div class="relative rounded-2xl p-8 mb-10 overflow-hidden group">
                ...
                <div class="relative z-10 flex flex-col md:flex-row items-center justify-between gap-4">
                    <div>
                        <h3 class="text-3xl font-black text-black tracking-tight">Halo, {{ Auth::user()->name }}! 👋</h3>
                        <p class="text-black/80 mt-2 text-lg font-medium">Selamat datang di Dashboard LONTARA 2025.</p>
                    </div>
                    @if($registration)
                        <div class="px-4 py-2 bg-black/10 rounded-lg backdrop-blur-sm border border-black/10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                ...
                <div class="bg-gray-900/80 border border-gray-800 rounded-2xl p-6 backdrop-blur-xl hover:border-gray-700 transition-all duration-300 group">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-gray-500 text-xs font-bold uppercase tracking-wider mb-1">Status Registrasi</p>
                            <p class="text-xl font-black {{ $registration ? 'text-green-400' : 'text-gray-400' }}">
                                {{ $registration ? 'Terdaftar' : 'Belum Mendaftar' }}
                            </p>
                        </div>
                        <div class="w-12 h-12 rounded-xl {{ $registration ? 'bg-green-500/20 text-green-400' : 'bg-gray-800 text-gray-500' }} flex items-center justify-center">
                ...
                <div class="bg-gray-900/80 border border-gray-800 rounded-2xl p-6 backdrop-blur-xl hover:border-gray-700 transition-all duration-300">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="text-gray-500 text-xs font-bold uppercase tracking-wider mb-1">Paper Submission</p>
                            <p class="text-xl font-black text-gray-400">Belum Dibuka</p>
                        </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div class="bg-gray-900/80 border border-gray-800 rounded-2xl overflow-hidden backdrop-blur-xl flex flex-col h-full">
                    ...
                    <div class="p-6 space-y-6 flex-1">
                        ...
                        <div class="flex gap-4">
                            <div class="flex flex-col items-center">
                                ...
                                <div class="h-full w-0.5 bg-gray-800 my-2"></div>
                            </div>
                            <div class="pb-6">
                                <h4 class="text-lg font-bold text-gray-200">Lengkapi Data Tim</h4>
                                @if($registration)
                                    <p class="text-sm text-green-400 mt-1">Data tim telah tersimpan.</p>
                                @else
                                    <p class="text-sm text-gray-500 mb-3">Isi formulir pendaftaran lomba & anggota tim.</p>
                                    <a href="{{ route('registration.create') }}" class="group inline-flex items-center px-5 py-2.5 bg-yellow-500 text-black font-bold rounded-lg hover:bg-yellow-400 transition-all shadow-[0_0_15px_rgba(234,179,8,0.3)]">
                                        Daftar Sekarang
                        ...
                        <div class="flex gap-4">
                            ...
                            <div>
                                <h4 class="text-lg font-bold {{ $registration ? 'text-gray-200' : 'text-gray-600' }}">Pembayaran Registrasi</h4>
                                @if($isPaid)
                                    <p class="text-sm text-green-400 mt-1">Pembayaran Lunas.</p>
                                @elseif($registration)
                                    <p class="text-sm text-gray-500 mb-3">Lakukan pembayaran untuk memvalidasi pendaftaran.</p>
                                    
                                    @if($isPending)
                                        <span class="inline-flex items-center px-3 py-1 bg-yellow-500/10 text-yellow-400 rounded border border-yellow-500/30 text-sm">Menunggu Verifikasi...</span>
                                    @elseif($isRejected)
                                        <a href="{{ route('payment.create') }}" class="text-red-400 underline font-bold text-sm">Upload Ulang Bukti</a>
                                    @else
                                        <a href="{{ route('payment.create') }}" class="group inline-flex items-center px-5 py-2.5 bg-gray-800 border border-yellow-500/50 text-yellow-400 font-bold rounded-lg hover:bg-yellow-500 hover:text-black transition-all">
                                            Upload Bukti Bayar
                                        </a>
                                    @endif
                                @else
                ...
                <div class="bg-gray-900/80 border border-gray-800 rounded-2xl overflow-hidden backdrop-blur-xl flex flex-col h-full">
                    ...
                    <div class="p-6 grid grid-cols-2 gap-4 flex-1">
                        <a href="{{ route('home') }}" class="flex flex-col items-center justify-center p-4 bg-black/40 border border-gray-700 rounded-xl hover:border-yellow-500 hover:bg-yellow-500/5 transition-all group">
                            ...
                            <span class="text-sm font-semibold text-gray-300 group-hover:text-yellow-400">Beranda</span>
                        </a>
                        ...
                        <a href="{{ route('about') }}" class="flex flex-col items-center justify-center p-4 bg-black/40 border border-gray-700 rounded-xl hover:border-yellow-500 hover:bg-yellow-500/5 transition-all group">
                            ...
                            <span class="text-sm font-semibold text-gray-300 group-hover:text-yellow-400">Tentang</span>
                        </a>
                        ...
                        <a href="{{ route('submission-info') }}" class="flex flex-col items-center justify-center p-4 bg-black/40 border border-gray-700 rounded-xl hover:border-yellow-500 hover:bg-yellow-500/5 transition-all group">
                            ...
                            <span class="text-sm font-semibold text-gray-300 group-hover:text-yellow-400">Panduan</span>
                        </a>
                        ...
                        <a href="{{ route('call-for-paper') }}" class="flex flex-col items-center justify-center p-4 bg-black/40 border border-gray-700 rounded-xl hover:border-yellow-500 hover:bg-yellow-500/5 transition-all group">
                            ...
                            <span class="text-sm font-semibold text-gray-300 group-hover:text-yellow-400">Jadwal</span>
                        </a>
                    </div>
                </div>
