<x-public-layout>
    ...
    <div class="flex items-center justify-center min-h-[60vh] bg-white">
        <div class="text-center">
            <div class="text-9xl font-bold text-red-600">500</div>
            <h1 class="mt-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl">Terjadi Kesalahan Server</h1>
            <p class="mt-6 text-base leading-7 text-gray-600">Maaf, terjadi masalah internal. Tim kami telah diberitahu dan sedang menanganinya.</p>
